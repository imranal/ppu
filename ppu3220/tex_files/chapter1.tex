...
kvaliteten på opplæringen (\citeNP[s. 92]{ludv15}). I utredningen, \emph{NOU 2015:8 Fremtidens skole}, vektlegges
...
\label{fig:skov98}
\end{figure}
I tabellen \ref{fig:skov98}, kartlegger \citeA{skov98} type oppgaver etter det han kaller \emph{opgaveparadigmet} :
...
drøfter oppgavene fra kartleggingsprøven (se vedlegg : \ref{sec:prove}). \citeA{skov98} beskriver oppgaveparadigmet som
