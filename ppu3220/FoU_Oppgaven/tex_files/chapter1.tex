...
inkluderer tallforståelse (\citeNP{grol06}). Dette har også jeg selv observert gjennom kartleggingsprøven. Det var 
...
I artikkelen \citeA[s.431]{foss14}, skriver hun at utstrakt bruk av individuell veiledning kan føre
...
syn på læring (\citeNP[s. 74]{salj13}). Ved ønsket atferd belønnes handlingen. Dette refereres som forsterking 
(\citeNP[s. 22]{hell07}). Innenfor vurderingskonteksten er hensikten å motivere elevene. Dermed er karakteren en 
...
(\citeNP[s. 162]{engh11}) 
\end{displayquote}
Vurderingsarbeidet vil derfor også gi den forskende lærer (\citeNP[s. 19]{hell07}) 
