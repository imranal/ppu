...
som kunne kunne ha bidratt til å øke deres forståelse (\citeNP[s. 176]{klet13}).
\newline
\newline
...
sine perspektiver på læring og utvikling (\citeNP[s. 13]{meli07}; \citeNP[s. 123]{bta98}; 
\citeNP[s. 87]{rogs13}; \citeNP[s. 299]{sjob04}; \citeNP[s. 62]{knai11}). Vygotskys mente at barns 
intellektuelle utvikling er formet utfra tilegnelse av språk, fordi språk muliggjør dialog mellom 
mennesker (\citeNP[s. 5]{meli07}; en tanke Jerome Bruner også ville ha støttet \citeNP{mcl08}). 
\newline
\newline
...
henviser til faglige termer og regnes derfor ikke som synonyme, men distinkte.}, som \citeA{meli07} 
...
(\citeNP[s. 14]{meli07}; \citeNP[s. 125]{bta98}; \citeNP[s. 75]{rogs13}). Bruner argumenterer at 
språk øker barns evnen til å håndtere abstrakte konsepter (\citeNP{mcl08}). Jeg brukte ``scaffolding'' 
