...
Ifølge \citeA{ludv15} vil læringsprosesser som fører til forståelse bidra til å styrke elevenes motivasjon og 
...
\end{displayquote}
Hos Vygotsky (\citeNP[s. 130]{bta98}), motivasjon ligger i å skape meningsfulle læringsbetingelser både ved å tilrettelegge 
...
med andres forestillinger i tillegg til naturvitenskapens forklaringer (\citeNP{odeg10}; \citeNP{dals94}).
...
begrepsforståelse, \citeA[s. ~175-176]{klet13}. Ved å forutse elevsvar før elever i klassen blir initiert, kan misforståelser som ofte oppstår bli redegjort
av læreren, og respons som ofte opptrer kan tas stilling til. Dette krever derimot en god del erfaring fra læreren sin side. \citeA[s. ~401]{batp08} klassifiserer 
...
Klette referer til en annen studie \citeA[s. ~176]{klet13} når hun viser til viktigheten av at lærerne legger til rette for \emph{systematisk trening, øvelse og 
...
ville ha spart tid som kunne da brukes av elever i faglig aktivitet. Ifølge \citeA[s. ~189]{klet13}, faktorer som har direkte effekt på elevenes læring,
...
er det også viktig å være klar over hvor mange frihetsgrader elever skal få (\citeNP{knai11}). Jo flere beslutninger eleven må ta selv, jo åpnere er oppgaven. Den først-nevnte
