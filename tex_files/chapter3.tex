...
organiserende prinsipp, blir sjelden gjennomført (\citeNP[s. 26]{odeg10}). Gjennom egen prasiserfaring
...
avgjøre bevisst på frihetsgrader elever skal få (\citeNP{knai11}). Jo flere beslutninger eleven 
...
(\citeNP[s. 31]{meli07}). Først og fremst er villigheten til deltagende til å dele sin forståelse 
...
for kollaborasjon. \citeA{klet13} kategoriserer dette som en underkategori i 
